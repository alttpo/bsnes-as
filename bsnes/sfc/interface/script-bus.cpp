...
struct Bus {
  ...
  static auto call_long(uint32 addr) -> void {
    // TODO: accept register values
    // TODO: switch this to a queue
    // TODO: add function to detect if call queue is empty
    ::SuperFamicom::cpu.call_long(addr);
  }
} bus;
...
auto RegisterBus(asIScriptEngine *e) -> void {
...

  {
    ...
    // call subroutine with long address:
    r = e->RegisterGlobalFunction("void call(uint32 addr)", asFUNCTION(Bus::call_long), asCALL_CDECL); assert(r >= 0);
  }
}
